...
X_train, Y_train, X_test, Y_test, preprocessor = preprocess_data(price_data, sequence_length,number_features)
...
print (inverse_scaler(predict_result,preprocessor)[:,-2])
